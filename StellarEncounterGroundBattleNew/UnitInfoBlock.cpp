...
UnitInfoBlock::UnitInfoBlock(GroundBattleScene * scene) {
	...
	block_tex = ResourceManager::LoadTexture("Graphics/UI/unitinfoblockrect.png");
	block_rect.h = 150;
	block_rect.w = 400;
	block_rect.x = 0;
	block_rect.y = scr_height - block_rect.h;

	portrait_tex = ResourceManager::LoadTexture("Graphics/UI/unitinfoblockportrait.png");
	portrait_rect.x = block_rect.x + 20;
	portrait_rect.y = block_rect.y + 20;
	portrait_rect.h = 110;
	portrait_rect.w = 110;

	hp_tex = ResourceManager::LoadTexture("Graphics/UI/unitinfoblockhpbar.png");
	...
	sp_tex = ResourceManager::LoadTexture("Graphics/UI/unitinfoblockspbar.png");
	sp_rect.x = hp_rect.x;
	...
	ap_tex = ResourceManager::LoadTexture("Graphics/UI/unitinfoblockapbar.png");
	ap_rect.x = hp_rect.x;
	...
	emptybar_tex = ResourceManager::LoadTexture("Graphics/UI/unitinfoblockemptybar.png");
